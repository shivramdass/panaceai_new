...
(function($, window, document, undefined) {
    ...
    $.fn.imageuploadify = function(opts) {
        ...
        this.each(function() {
            ...
            let counter = 0;
			let counter_nb = 0;
            let dragbox = $(`<div class="imageuploadify well"><div class="imageuploadify-overlay"></div>
			<div class="imageuploadify-images-list text-center">
			<button type="button"class="btn btn-default none_hov"> 
				<div class="image-box text-center">
					<p> <i class="fa fa-cloud-upload" aria-hidden="true"></i>
						Upload Logo Image
					</p>
				</div>
			</button>
            ...
            const readingFile = (id, file) => {
                ...
                let container = $("<div class='imageuploadify-container'><button type='button' data='"+counter_nb+"' class='btn btn-danger glyphicon glyphicon-remove'></button><div class='imageuploadify-details'><span>${file.name}</span><span>${file.type}</span><span>${file.size}</span></div></div>");
            ...
            const disableMouseEvents = () => {
                ...
                dragbox.css("border-color", "#c8202d");
            ...
            button.mouseenter(function onMouseEnter(event) {
                ...
                button.css("background", "white").css("color", "");
            });
